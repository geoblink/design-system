...
describe('GeoCalendarNavigationDay', () => {
  ...
  describe('Month selection', () => {
    ...
    it('Should have a fixed list of months', () => {
    ...
    it('Should emit an event when clicking on one of the months', () => {
      wrapper.findAll('[data-ut="month-select"] .geo-list-item').at(10).trigger('click')
