...
<template>
  <div class="element-demo">
    ...
    <div class="element-demo__block" style="width: 120px;">
      ...
      <geo-info-segmented-control-item disabled active>
    ...
    <div class="element-demo__block" style="width: 120px;">
      ...
      <geo-info-segmented-control-item outline active>
        Active option
      </geo-info-segmented-control-item>
      ...
      <geo-info-segmented-control-item outline disabled>
        Disabled option
      </geo-info-segmented-control-item>

      <geo-info-segmented-control-item outline disabled active>
        Active disabled option
      </geo-info-segmented-control-item>
    </div>
  </div>
